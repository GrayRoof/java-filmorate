...
ALTER TABLE FILM
    ADD CONSTRAINT IF NOT EXISTS fk_Film_RatingID FOREIGN KEY (RATINGID)
        REFERENCES MPA (RATINGID) ON DELETE RESTRICT;

ALTER TABLE LIKES
    ADD CONSTRAINT IF NOT EXISTS fk_Like_UserID FOREIGN KEY (UserID)
        REFERENCES USERS (UserID) ON DELETE CASCADE;

ALTER TABLE LIKES
    ADD CONSTRAINT IF NOT EXISTS fk_Like_FilmID FOREIGN KEY (FilmID)
        REFERENCES Film (FilmID) ON DELETE CASCADE;

ALTER TABLE FRIENDSHIP
    ADD CONSTRAINT IF NOT EXISTS fk_Friendship_UserID FOREIGN KEY (UserID)
        REFERENCES USERS (UserID) ON DELETE CASCADE;

ALTER TABLE FRIENDSHIP
    ADD CONSTRAINT IF NOT EXISTS fk_Friendship_FriendID FOREIGN KEY (FriendID)
        REFERENCES USERS (UserID) ON DELETE CASCADE;

ALTER TABLE GENRELINE
    ADD CONSTRAINT IF NOT EXISTS fk_GenreLine_FilmID FOREIGN KEY (FilmID)
        REFERENCES FILM (FilmID) ON DELETE CASCADE;

ALTER TABLE GENRELINE
    ADD CONSTRAINT IF NOT EXISTS fk_GenreLine_GenreID FOREIGN KEY (GenreID)
        REFERENCES GENRE (GenreID) ON DELETE RESTRICT;

ALTER TABLE REVIEWS
    ADD CONSTRAINT IF NOT EXISTS fk_Reviews_FilmID FOREIGN KEY (FilmID)
        REFERENCES FILM (FilmID) ON DELETE CASCADE;

ALTER TABLE DIRECTORLINE
    ADD CONSTRAINT IF NOT EXISTS fk_DirectorLine_FilmID_foreign FOREIGN KEY (FilmID)
        REFERENCES FILM (FilmID) ON DELETE CASCADE;

ALTER TABLE REVIEWS
    ADD CONSTRAINT IF NOT EXISTS fk_Reviews_UserID FOREIGN KEY (UserID)
        REFERENCES USERS (UserID) ON DELETE CASCADE;

ALTER TABLE EVENTS
    ADD CONSTRAINT IF NOT EXISTS fk_Events_UserID FOREIGN KEY (UserID)
        REFERENCES USERS (UserID) ON DELETE CASCADE;

ALTER TABLE USEFUL
    ADD CONSTRAINT IF NOT EXISTS fk_Useful_UserID FOREIGN KEY (UserID)
        REFERENCES USERS (UserID) ON DELETE CASCADE;

ALTER TABLE DIRECTORLINE
    ADD CONSTRAINT IF NOT EXISTS fk_DirectorLine_DirectorID FOREIGN KEY (DirectorID)
        REFERENCES DIRECTORS (DirectorID) ON DELETE CASCADE;

ALTER TABLE EVENTS
    ADD CONSTRAINT IF NOT EXISTS fk_Events_Operation FOREIGN KEY (Operation)
        REFERENCES OPERATIONS (OperationID) ON DELETE RESTRICT;

ALTER TABLE EVENTS
    ADD CONSTRAINT IF NOT EXISTS fk_Events_EventType FOREIGN KEY (EventType)
        REFERENCES EVENTTYPES (TypeID) ON DELETE RESTRICT;

ALTER TABLE USEFUL
    ADD CONSTRAINT IF NOT EXISTS fk_Useful_ReviewID FOREIGN KEY (ReviewID)
