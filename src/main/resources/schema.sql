...
ALTER TABLE "Film" ADD CONSTRAINT IF NOT EXISTS "fk_Film_RatingID" FOREIGN KEY("RatingID")
    REFERENCES "RatingMPA" ("RatingID");

ALTER TABLE "Like" ADD CONSTRAINT IF NOT EXISTS "fk_Like_UserID" FOREIGN KEY("UserID")
    REFERENCES "User" ("UserID");

ALTER TABLE "Like" ADD CONSTRAINT IF NOT EXISTS "fk_Like_FilmID" FOREIGN KEY("FilmID")
